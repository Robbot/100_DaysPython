...
title_label.grid(column=2, row=1, padx=2, pady=2)
...
button1.grid(column=1, row=3, padx=2, pady=2)

button2 = Button(text="Reset", command=Reset, highlightthickness=0)
button2.grid(column=3, row=3, padx=2, pady=2)

check_marks = Label(text="", bg=YELLOW, fg=GREEN, font=(FONT_NAME, 20))
check_marks.grid(column=2, row=4, padx=2, pady=2)
